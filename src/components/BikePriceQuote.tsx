...
export function BikePriceQuote() {
  const [selectedClass, setSelectedClass] = useState<string>('GT');
  ...
  return (
    <div className="flex flex-col min-h-full bg-[#F5F4F0] pb-24">
      ...
      <div className="bg-white border-b border-black/10 px-4 pt-4 pb-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-[15px] font-bold tracking-widest uppercase">Bike Booking Engine</h1>
